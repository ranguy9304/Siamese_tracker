...
def main():
    ...
    siamese = model.model_maker().load_siamese()
    crop_images_labels = []
    ...
    for epoch in tqdm(range(epochs), desc="Epochs", unit="epoch"):
        ...
        for j in range(0,len_crop_train//batch_size):
            ...
            siamese.train_siamese('C:/Users/divya/Desktop/ML/ODCL/saimese_tracker/', "C:/Users/divya/Desktop/ML/ODCL/saimese_tracker/", crops_train[temp_batch_low:temp_batch_high], labels_train[temp_batch_low:temp_batch_high])
            temp_batch_low = temp_batch_high
            temp_batch_high = temp_batch_high + batch_size
        siamese.train_siamese('C:/Users/divya/Desktop/ML/ODCL/saimese_tracker/', "C:/Users/divya/Desktop/ML/ODCL/saimese_tracker/", crops_train[temp_batch_low:], labels_train[temp_batch_low:])
